    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(isDijkstra) {
            ...
            when(continente){
                ...
                0->totalDistance = FloydWarshall.doCalcs(grafoFloydWarshall,13, startPoint,finishPoint).toInt()
                1->totalDistance = FloydWarshall.doCalcs(grafoFloydWarshall,16, startPoint, finishPoint).toInt()
                2->totalDistance = FloydWarshall.doCalcs(grafoFloydWarshall,12, startPoint, finishPoint).toInt()
            }
        }
